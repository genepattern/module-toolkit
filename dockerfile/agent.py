...
- ALWAYS place a comment above each changed line in the Dockerfile stating this agent edited it.  If no lines are edited place a comment at the end stating the agent accepted the file as-is.
